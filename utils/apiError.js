/**
 * Operational error with an HTTP status code attached, so the centralized
 * error middleware can respond correctly without leaking internals.
 */
class ApiError extends Error {
  ...
  static unauthorized(message = "Not authorized") { return new ApiError(401, message); }
